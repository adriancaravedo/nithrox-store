...
export const DEFAULT_PLANS = [
  ...
  },
  {
    ...
    payment_schedule: [
      ...
      { phase: 2, label: { es: 'Diseño aprobado', en: 'Design approved' }, pct: 30 },
      { phase: 3, label: { es: 'Desarrollo completado', en: 'Development complete' }, pct: 30 },
      { phase: 4, label: { es: 'Entrega final', en: 'Final delivery' }, pct: 30 },
    ],
    base_pages: 5,
    page_options: [
